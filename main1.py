...
class CosmoFood:     
    def __init__(self, kalori, berat, gula, POPULATION_SIZE=100, n_ingredients_=3):
        self.kalori = kalori
        self.berat = berat
        self.gula = gula
    ...
    def run(self):
        ...
        llm_res = GeminiAgent(population[0].chromosome,"AIzaSyDoMcfMG4pAEibApynt4OgOIZmUuzztaLM").run()
